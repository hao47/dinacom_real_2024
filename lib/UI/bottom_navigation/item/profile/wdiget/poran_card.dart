...
class PoranCardItemProfile extends GetView<PoranController> {
  int index;
  ResponseProfileModel response;
  BuildContext? newContext;

  PoranCardItemProfile({super.key, required this.response, this.newContext,required this.index});
